 ...
 * - Advanced filter area can be expanded/collapsed
 * - Displays current active filter tags
...
interface SearchFilterProps {
  ...
  /** 
   * Filter criteria change callback function
...
const SearchFilter: React.FC<SearchFilterProps> = ({
   ...
   * 
   * Resets all filter criteria to initial values
   * 
   ...
   * 
   * Checks whether any filter criteria are non-empty values
   * 
   ...
   * 
   * Counts the number of non-empty filter criteria for display on the button
   * 
