 ...
 * - Advanced filter area can be collapsed/expanded
 * - Displays current active filter condition tags
 ...
 * - Tag: Filter condition tag
 * 
 * State Management:
 * - expanded: Controls expand/collapse state of advanced filter area
 * 
 * @module SearchFilter
 */
...
interface SearchFilterProps {
  ...
  /** Loading state, controls search button loading effect */
  loading?: boolean;
}
...
const SearchFilter: React.FC<SearchFilterProps> = ({
   ...
   * 
   * Reset all filter conditions to initial values
   * 
   ...
   * 
   * Check if any filter conditions are non-empty
   * 
  ...
  /**
   * Get number of active filter conditions
   * 
   * Count number of non-empty filter conditions for display on button
   * 
